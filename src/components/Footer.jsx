...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000] border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold mb-4">KOODAM</h3>
            <p className="text-white/60 text-sm">
              Discover unique resorts and create unforgettable memories.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              ...
              <li>
                <a href="/resorts" className="hover:text-teal-400 transition-colors">
                  Resorts
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-400 transition-colors"
              >
              ...
              <motion.a
                href="https://www.instagram.com/koodam.in/"
                target="_blank"
        ...
        <div className="mt-8 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/60 text-sm">
              © {currentYear} KOODAM. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex items-center space-x-2">
              <svg className="w-4 h-4 text-white/40" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z"/>
              </svg>
              <span className="text-white/40 text-xs">Made with ❤️ for travelers</span>
            </div>
          </div>
        </div>
      </div>
