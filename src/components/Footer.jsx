        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
               <img src="/logo.png" alt="Kyte" className="w-8 h-8 rounded-full" />
               <h3 className="text-xl font-bold text-white">KYTE</h3>
            </div>
            <p className="text-white/60 text-sm">
              Find the perfect stay, your way. From budget friendly to luxury resorts.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              ...
              <li>
                <a href="/admin" className="hover:text-brand-accent transition-colors">
                  Partner Login
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-accent hover:text-white text-white/60 transition-colors"
              >
              ...
              <motion.a
                href="https://www.instagram.com/kytetravelpartner/"
                target="_blank"
        ...
        <div className="mt-8 pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/40 text-sm">
              © {currentYear} Kyte Travel Partner. All rights reserved.
            </p>
            <div className="flex items-center space-x-2">
              <span className="text-white/40 text-xs">Made with ❤️ for wanderlusters</span>
            </div>
          </div>
        </div>
      </div>
